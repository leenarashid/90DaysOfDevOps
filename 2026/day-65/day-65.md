...
![Module Heirarchy](images/task1.1.png)


**Document:** What is the difference between a "root module" and a "child module"?

**ROOT MODULE:**
The root module is the main Terraform configuration where execution starts and commands like terraform apply are run; it defines and controls the overall infrastructure.


**CHILD MODULE:**
A child module is a reusable set of configurations called by the root module to handle specific tasks, making the code modular and easier to manage.Like creation of vpc,ec2,sg etc
...
**Answer:**
Both of the servers are shown, running along with the tags and their respective VPC,subnets,IGW and route tables.
...
![API-Server](images/2.1.1.png)

![API-Server-Tags](images/2.1.2.png)

**WEB SERVER**

![WEB-Server](images/2.2.1.png)
![WEB-Server-Tags](images/2.2.2.png)

**VPC**

![VPC](images/vpc-(first-task).png)
...
**API-SERVER**
![API-Server](images/5.2.1.png)

![API-Server](images/5.2.2.png)

**WEB-SERVER**

![WEB-Server](images/5.1.1.png)
![WEB-Server](images/5.2.1.png)


**VPC**
![VPC](images/5.3.0.png)
