...
<p align="center">
  <a href="https://github.com/leenarashid/github-capstone-project-repo/actions/workflows/main-pipeline.yml/main-pipeline.yml">
    <img src="https://github.com/leenarashid/github-capstone-project-repo/actions/workflows/main-pipeline.yml/badge.svg" alt="Main Pipeline Status">
  </a>
  <a href="https://github.com/leenarashid/github-capstone-project-repo/actions/workflows/pr-pipeline.yml/pr-pipeline.yml">
    <img src="https://github.com/leenarashid/github-capstone-project-repo/actions/workflows/pr-pipeline.yml/badge.svg" alt="PR Pipeline Status">
  </a>
  <a href="https://github.com/leenarashid/github-capstone-project-repo/actions/workflows/health-check.yml">
    <img src="https://github.com/leenarashid/github-capstone-project-repo/actions/workflows/health-check.yml/badge.svg" alt="Health Check Status">
  </a>
...
**Verify:** Merge a PR to `main` — does it run tests → build Docker → deploy in sequence?
  ...
  - Yes Run test → build docker → deploy to production
    ...
    ![Main Pipeline](images/main-pipeline-original.png)
