...
4. Fix it — verify it goes green again
   ...
   ![image](images/5-1(error code2).png)




   [workflow](workflows/task5.yml)
...
3. Write in your notes: What is being cached and where is it stored?
 ...
 ![image](images/6-1(no-cache).png)
  


[workflow](workflows/task6-1.yml)
 
 
![image](images/6(final).png)

   [workflow](workflows/task6-2.yml)
