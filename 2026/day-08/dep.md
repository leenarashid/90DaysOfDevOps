...
<img src="cloud/1.png" width="900">

>## `SSH Connection:`
SSH connection has been established following the steps,using the downloaded .pem key of the instance.Connection has been established.
...
># `Challenges:`
- The major challenge was the use of scp command.Initially I entered the command while being logged in as ubuntu user.
># `Major Learning:`
- Editing inbound rules for nginx to accept outer traffic.
- The use of scp command and complete understanding of recording and saving logs in a text file,which will be stored on the local.
